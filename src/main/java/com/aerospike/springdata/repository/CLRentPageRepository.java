 ...
 * the License.
 */
package com.aerospike.springdata.repository;
...
public interface CLRentPageRepository extends AerospikeRepository<CLRentPage, String> {
	...
	public List<CLRentPage> findByGeoLocationWithinAndPostDateAfter(double lon, double lat, double radius, long dateTime);  //dateTime is equivalent to java util.Date.getTime()
